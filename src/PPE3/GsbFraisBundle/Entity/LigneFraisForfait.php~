...
class LigneFraisForfait
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="PPE3\GsbFraisBundle\Entity\Fraisforfait")
     ...
     * @return LigneFraisForfait
     */
    public function setFraisForfait(\PPE3\GsbFraisBundle\Entity\Fraisforfait $fraisForfait = null)
    {
